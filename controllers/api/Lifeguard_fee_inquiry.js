...
class Lifeguard_fee_inquiry extends ApiController{
  constructor() {
    super()
  ...
  index = async () => {
    ...
    this.call_lifeguard_fee_inquiry();
    
  }


  call_lifeguard_fee_inquiry = async () => {
    let response =  await this.ussc_ws.lifeguard_fee_inquiry()
...
module.exports = new Lifeguard_fee_inquiry();