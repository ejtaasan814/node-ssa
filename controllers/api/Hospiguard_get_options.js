...
class Hospiguard_get_options extends ApiController{
  constructor() {
    super()
  ...
  index = async () => {
    ...
    const response = await this.ussc_ws.hospiguard_get_options(post_data);
...
module.exports = new Hospiguard_get_options();